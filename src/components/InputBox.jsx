...
function InputBox({
  ...
  return (
    <div className={`bg-white p-3 rounded-lg text-sm flex ${className}`}>
      <div className='w-1/2'>
        <label htmlFor={amountInputId} className='text-lg text-black mb-2 inline-block'>{label}</label>   
        <input 
      ...
      <div className='w-1/2 flex flex-wrap justify-end text-right'>
        <p className=' text-lg text-gray-500 mb-2 w-full'>Currency Type</p>
        <select 
  className='rounded-lg px-1 py-1 bg-gray-200 cursor-pointer text-lg'
